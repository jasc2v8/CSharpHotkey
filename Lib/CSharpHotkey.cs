    ...
    public partial class CSharpHotkey
    {
        ...
        public bool ClipWait(double TimeoutSeconds, string DataFormats = "Text")
        {
            ...
            while (DateTime.Now < waitTime)
            {
                ...
                if (System.Windows.Clipboard.ContainsData(DataFormats))
        ...
        private class Win32
        {
            ...
            [DllImport("user32.dll", CharSet = CharSet.Auto, SetLastError = true)][return: MarshalAs(UnmanagedType.Bool)] public static extern bool GetWindowRect(IntPtr hWnd, out Rectangle lpRect);
