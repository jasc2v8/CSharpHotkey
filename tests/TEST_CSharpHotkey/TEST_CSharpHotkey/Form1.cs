...
namespace csHotKeyTest
{
    public partial class Form1 : Form
    {
        ...
        private void buttonGet_Click(object sender, EventArgs e)
        {
            ...
            WriteLine("");
            WriteLine("Win.Get:");
            WriteLine("EXIST:\t\t" + Win.Get(GET.Exist, "_name TestWindow"));
            WriteLine("WS_DISABLED:\t" + Win.Get(GET.Disabled));
            WriteLine("WS_MAXIMIZE:\t" + Win.Get(GET.Maximize));
            WriteLine("WS_MINIMIZE:\t" + Win.Get(GET.Minimize));
            WriteLine("WS_VISIBLE:\t" + Win.Get(GET.Visible));
            WriteLine("NORMAL: \t" + Win.Get(GET.Normal));
        ...
        private void DoWriteInfo(string WinTitle)
        {
            ...
            WriteLine("ID: \t\t" + Win.Get(GET.ID));
            WriteLine("PID: \t\t" + Win.Get(GET.PID));
            WriteLine("ProcessName: \t" + Win.Get(GET.ProcessName));
            WriteLine("ProcessPath: \t" + Win.Get(GET.ProcessPath));
        ...
        private void buttonHotKey_Click(object sender, EventArgs e)
        {
            ...
            hotkeyD1 = new HotKey(HotKey.Modifiers.ControlAlt, Keys.D1, (none) =>
            {
        ...
        private void buttonMinMax_Click(object sender, EventArgs e)
        {
            ...
            Win.Set(SET.AlwaysOnTop, this.Text);
